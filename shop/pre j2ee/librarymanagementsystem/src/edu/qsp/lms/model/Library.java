...
public class Library {
	...
	public String toString() {
		return "Library [libraryName=" + libraryName + ", libraryAddress=" + libraryAddress + ", libraryPincode="
				+ libraryPincode + ", books=" + books + ", getLibraryName()=" + getLibraryName()
				+ ", getLibraryAddress()=" + getLibraryAddress() + ", getLibraryPincode()=" + getLibraryPincode()
				+ ", getBooks()=" + getBooks() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
